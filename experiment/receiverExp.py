...
from src.experiment import RunReceiverGame, MoveAgent
...
runGame = RunReceiverGame(game, trueGoalIndex, agentsCoord,
                 signalsColor, signalsShape, signalsCoord,
                 targetsColor, targetsShape, targetsCoord,
                 displayGame, drawInitialScreen, drawScreen, drawSignaler, drawReceiver,
